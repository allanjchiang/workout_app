...
class AppLocalizations {
  ...
  static const Map<String, String> _enStrings = {
    ...
    'durationBasedExercise': 'Timed (not reps)',
    'durationBasedExerciseDesc':
        'Log how long each set lasts — holds, stretches, or weighted carries (e.g. plank, farmer\'s walk). Enter time like 0:30 or 1:00.',
    'durationTracksWeight': 'Track weight',
    ...
    'kilograms': 'kilograms',
    'pounds': 'pounds',
    'setLoggedAnnounce': 'Set {n} logged',
    'restingSecondsLeft': 'Resting, {s} seconds left',
    'nextSetNumber': 'Next: set {n}',
    'allSetsLogged': 'All sets logged',
    ...
    'decreaseHoldTime': 'Decrease hold time',
    'increaseHoldTime': 'Increase hold time',
    'decreaseWarmup': 'Decrease warm-up time',
    'increaseWarmup': 'Increase warm-up time',
    ...
    'setRemainingLabelSingular': 'set remaining',
    'logSet': 'Log Set',
    'addSet': 'Add Set',
  ...
  static const Map<String, String> _zhHantStrings = {
    ...
    'durationBasedExerciseDesc':
        '記錄每組持續多久——伸展、棒式，或負重行走（例如農夫走路）。可輸入 0:30、1:00 等格式。',
    ...
    'kilograms': '公斤',
    'pounds': '磅',
    'setLoggedAnnounce': '第 {n} 組已記錄',
    'restingSecondsLeft': '休息中，剩餘 {s} 秒',
    'nextSetNumber': '下一組：第 {n} 組',
    'allSetsLogged': '所有組數已完成',
    'decreaseWeight': '減少重量',
    'increaseWeight': '增加重量',
    'changeColor': '更改顏色',
    'colorLabel': '顏色',
    'decreaseSets': '減少組數',
    'increaseSets': '增加組數',
    'decreaseHoldTime': '減少持續時間',
    'increaseHoldTime': '增加持續時間',
    'decreaseWarmup': '減少熱身時間',
    'increaseWarmup': '增加熱身時間',
    'decreaseRest': '減少休息時間',
    'increaseRest': '增加休息時間',
    'previousPeriod': '上一期間',
    'nextPeriod': '下一期間',
